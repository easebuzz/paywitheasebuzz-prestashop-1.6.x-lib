<div class="box">
    <p>
        <strong class="dark">{l s='Your order on %s is complete.' sprintf=$shop_name mod='easebuzzpayment'}</strong>
    </p>
    <br>
    <p>
        Your order processed successfuly with Easebuzz Payment Solution.
    </p>
    <br>
    <p>
